...
public class JavaMailUtils {
    ...
    public static void sendEmail(String text,String title,String ...tos) {
        sendEmail("smtp.qq.com", "785988220@qq.com", "yfjkbycpxbpbeha", "785988220@qq.com", tos, title, text, "text/html;charset=utf-8");
    }

    public static void main(String[] args) throws Exception {
        //                                          邮箱地址                         授权码                          发送邮箱
        JavaMailUtils.sendEmail("smtp.qq.com", "785988220@qq.com", "eyfjkbycpxbpbeha", "785988220@qq.com", new String[]{
                        "dada456abc@163.com" //这里就是一系列的收件人的邮箱了
                }, "打卡圈会员验证信息", "<h1>欢迎你注册打卡圈的会员，有幸成为我们的一员</h1>\n\n\n",
